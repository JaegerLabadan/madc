    ...
    <div class="container-fluid about-contain">
        <div class="row hero-mobile">
            <div class="flex-container mobhero-content mx-auto">
                <div class="mob-logo ">
                <a href="{{ url('/') }}">
                    <img class="img-fluid" src="{{ asset('img/madc-logo-black.png') }}"
                        alt="MADC-logo">
                    </a>
                </div>
        ...
        <div class="row p-5 justify-content-center align-items-center all-serv1-row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4 shadow" style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/zircona.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4 shadow " style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/feldspathic.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4 shadow" style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/direct-veeners.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 mt-4 col-md-6">
                <div class="card shadow" style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/dental-implant.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4 shadow" style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/prosthodonthics.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4  col-md-6">
                <div class="card mt-4 shadow" style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/general.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4 shadow " style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/oral-esthetic.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-4 shadow" style="width: width: 100%;max-height:480px;height:480px;">
                    <img src="{{ asset('/photos/dental-surgery.jpg') }}"
                        class="card-img-top d-flex mx-auto all-serv-img1" alt="...">
                    <div class="card-body">
        ...
        <div class="footer-row-mobile" style="background: white;">
            <div class="flex-container footer-contain mx-auto">
                ...
                <div class="footer-logo mx-auto">
                    <img class="img-fluid " src="{{ asset('photos/madc-logo.png') }}" alt="MADC-logo">
                </div>
                ...
                <div class="footer-buttons mx-auto">
                    <button type="button" class="footer-btn1"><span class="m-auto">BOOK AN APPOINTMENT
                            NOW</span></button>
                    <button type="button" class="footer-btn2"><span class="m-auto">GET DIRECTIONS TO THE
                            CLINIC</span></button>
                </div>
            </div>
            ...
            <div class="flex-container trademark-contain ">
                <div class="trademark  ">
                    <span>MADC DENTAL CLINIC</span><span style="color:#db5b02;"> | THE SMILE MAKE-OVER
                        SPECIALIST</span><br>
        ...
        <div class="row footer-row-desktop ">
            <div class="col-md-8 col-lg-8 footer-map">
                ...
                <div id="map-container-google-4" class="z-depth-1-half map-container-4">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m24!1m12!1m3!1d126273.7810600469!2d124.5562526473576!3d8.493969632340988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m9!3e6!4m3!3m2!1d8.493799899999999!2d124.6266338!4m3!3m2!1d8.4938061!2d124.62629369999999!5e0!3m2!1sen!2sph!4v1591195635717!5m2!1sen!2sph"
            ...
            <div class="col-md-4 col-lg-4 footer-mapside" style="background: white;">
                <div class="flex-container mapside-contain mx-auto">
                    <div class="mapside-logo mx-auto">
                        <img class="img-fluid " src="{{ asset('img/madc-logo.png') }}"
                            alt="MADC-logo">
                    </div>
        ...
        <div class="desktop-trademark ">
            <div class="flex-container footer-mapbot mx-auto">
                ...
                <div class="col-md-5 col-lg-5 footer-mapbot-right">
                    ...
                    <span>
                        <a href="https://www.facebook.com/madcdentalclinic"
                            class="text-secondary text-decoration-none">FACEBOOK</a>
                    </span><span style="color:#db5b02;"> | </span>
                    <span>
                        <a href="https://www.instagram.com/madcdentalclinic/?hl=en"
                            class="text-secondary text-decoration-none">INSTAGRAM</a>
                    </span>
                </div>
            </div>
